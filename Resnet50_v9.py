"""
V9: larger kernel size - kernel size 9
"""
...
class Bottleneck(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = nn.Conv2d(inplanes, inplanes, kernel_size=9, padding=3, groups=inplanes) # depthwise convolution
...
def resnet50_v9(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
