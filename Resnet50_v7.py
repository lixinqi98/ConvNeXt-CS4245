"""
V7: larger kernel size - kernel size 5
"""
...
class Bottleneck(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = nn.Conv2d(inplanes, inplanes, kernel_size=5, padding=2, groups=inplanes) # depthwise convolution
...
def resnet50_v7(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
